...
def render_pages(config, partitions, env, now_str):
    pages = [
        ("index.html",    OUTPUT_DIR / "index.html",
         {"articles": partitions["latest"], "results": partitions["latest_results"],
          "categories": partitions["categories"]}),
        ("feed.html",     OUTPUT_DIR / "feed" / "index.html",
         {"articles": partitions["all"], "categories": partitions["categories"]}),
        ("results.html",  OUTPUT_DIR / "resultados" / "index.html",
         {"articles": partitions["results"]}),
        ("news.html",     OUTPUT_DIR / "noticias" / "index.html",
         {"articles": partitions["noticias"], "categories": partitions["categories"]}),
    ]
